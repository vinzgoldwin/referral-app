<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200">Edit Referral Website</h1>
    ...
    <form wire:submit.prevent="updateWebsite" class="space-y-4">
        <div>
            <label class="block text-gray-700 dark:text-gray-200 mb-1">Website URL</label>
            <input wire:model="url" type="url" class="p-2 border rounded w-full text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-700">
        </div>
