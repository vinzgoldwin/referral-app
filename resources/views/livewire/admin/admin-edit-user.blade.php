<div class="container mx-auto p-4">
    ...
    <form wire:submit.prevent="updateUser" class="bg-white dark:bg-gray-800 p-6 rounded shadow-md">
        ...
        <div class="mb-4">
            ...
            <select wire:model.defer="status" class="mt-1 p-2 border rounded w-full text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600">
